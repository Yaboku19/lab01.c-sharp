...
namespace ComplexAlgebra
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(onePlusI.Im); // 1
            ...
            Console.WriteLine(iPlusOne.Im); // 1
            ...
            Console.WriteLine(oneMinusI.Im);  // -1
